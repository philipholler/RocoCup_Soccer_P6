...
class SoccerSim(threading.Thread):
    ...
    def start(self) -> None:
        ...
        self.soccer_monitor = subprocess.Popen(["exec rcssmonitor --show-status-bar 1 --show-kick-accel-area 1 --show-catch-area 1 --geometry=1280x800 --show-stamina 1"], shell=True)
