...
class TestWorldViewCoach(TestCase):
    def test_get_closest_players_to_ball_00(self):
        wv = WorldViewCoach(0)
        ...
        result: [PlayerViewCoach] = wv.get_closest_players_to_ball(3)
    ...
    def test_get_closest_players_to_ball_01(self):
        wv = WorldViewCoach(0)
        player1 = PlayerViewCoach("Team1", "1", False, Coordinate(10, 10), 0, 0, 0, 0)
        player2 = PlayerViewCoach("Team1", "2", False, Coordinate(5, 5), 0, 0, 0, 0)
        ...
        result: [PlayerViewCoach] = wv.get_closest_players_to_ball(2)
